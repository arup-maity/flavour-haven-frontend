...
const AdminLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div
      className={`webx-admin-panel relative w-full h-full bg-gray-100 dark:bg-dark-skin`}
    >
      <div
        className={clsx(
          `webx-admin-sidebar fixed bg-white flex flex-col start-0 transition-all duration-400 ease-in-out z-50`,
          {
            expanded: menuHover
          }
        )}
