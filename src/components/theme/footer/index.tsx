...
const Footer = () => {
   return (
      <footer className="theme-container bg-white text-[]#0c0c0c divide-y">
         ...
         <div className="py-4 text-sm text-center dark:text-gray-400">© 1968 Company Co. All rights reserved.</div>
      </footer>
   );
};
