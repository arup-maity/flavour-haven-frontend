            ...
            <div className="theme-container">
               <div className="text-white flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 -m-4">
                  <div className="w-full lg:w-1/3 p-4">
                     ...
                     <p className="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae, corrupti cupiditate aut iste et explicabo fugiat. Molestiae nobis maxime excepturi nostrum ipsam dolore id distinctio?</p>
                  ...
                  <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3 p-4">
                     ...
                     <div className="space-y-3">
                        ...
                        <ul className="space-y-2">
                           <li className="flex gap-2">
                              <PiMapPin size={18} className="mt-1" />
                              <p className="text-base">Kolkata, West Bengal, India 700066</p>
                           </li>
                           ...
                           <li className="flex items-center gap-2">
                              ...
                              <p className="text-base">me@arupmaity.in</p>
                           </li>
                           <li className="flex items-center gap-2">
                              <GoClock size={17} />
                              <p className="text-base">Sun - Sat / 10:00 AM - 8:00 PM</p>
                           </li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div className="py-4 text-sm text-center text-white border-t">© 2024 Company Co. All rights reserved.</div>
            </div>
         </footer>
      </>
   );
