            ...
            <div className="px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
               <div className="mb-4">
                  <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                     <h2
                        className="mb-4 font-semibold tracking-tight text-gray-900 dark:text-white text-xl sm:text-5xl">
                        Get in Touch
                     </h2>
                  ...
                  <div className="grid md:grid-cols-2">
                     <div className="h-full pr-6">
                        ...
                        <ul className="mb-6 md:mb-0">
                           <li className="flex">
                              <div className="flex h-10 w-10 items-center justify-center rounded bg-[#195A00]  text-gray-50">
                              ...
                              <div className="ml-4 mb-4">
                                 ...
                                 <p className="text-gray-600 dark:text-slate-400">1179, Sector 67, Mohali</p>
                                 <p className="text-gray-600 dark:text-slate-400">Punjab, India</p>
                              </div>
                           </li>
                           <li className="flex">
                              <div className="flex h-10 w-10 items-center justify-center rounded bg-[#195A00]  text-gray-50">
                              ...
                              <div className="ml-4 mb-4">
                                 ...
                                 <p className="text-gray-600 dark:text-slate-400">Mobile: +91 (790) 080-78976</p>
                                 <p className="text-gray-600 dark:text-slate-400">Mail: me@arupmaity.in</p>
                              </div>
                           </li>
                           <li className="flex">
                              <div className="flex h-10 w-10 items-center justify-center rounded bg-[#195A00]  text-gray-50">
                     ...
                     <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                        ...
                        <form id="contactForm">
                           ...
                           <div className="text-center">
                              <button type="submit" className="w-full bg-[#195A00]  text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                           </div>
                        </form>
                     </div>
                  </div>
