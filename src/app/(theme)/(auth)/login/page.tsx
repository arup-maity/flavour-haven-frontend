   ...
   return (
      <div className="w-full min-h-screen bg-[#F4F4F4]">
         <div className="w-full h-full flex flex-nowrap items-center justify-between py-10">
            ...
            <div className="w-full lg:w-5/12 px-10">
               <div className="w-full h-full flex items-center bg-white rounded-lg shadow-[0px_4px_15px_0px_#0000001C] p-4 md:p-16">
                  <div className="w-full">
                     ...
                     <div className="w-full flex flex-col justify-center space-y-4 mb-6">
                        <Link href={process.env.NEXT_PUBLIC_API_URL + `/auth/google-auth`} className="h-14 w-full flex flex-nowrap items-center justify-center space-x-3 rounded-lg shadow-[0px_4px_15px_0px_#0000001C] mx-auto">
                           <svg
